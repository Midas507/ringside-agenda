...
import { LogOut, Plus, Pencil, Trash2, Calendar as CalIcon, Star, Archive, Eye, MousePointerClick, BarChart3, Megaphone, Check, X, MessageCircle } from "lucide-react";
...
export default function AdminDashboard() {
  ...
  const [tab, setTab] = useState<"shows" | "past" | "federations" | "promoteurs" | "comments">("shows");
  ...
  async function fetchData() {
    const [showsRes, fedsRes, showStatsRes, fedStatsRes, promoteursRes, commentsRes] = await Promise.all([
    ...
    // Enrichir les commentaires avec titres de shows et infos utilisateurs
        ...
        {loading ? (
                  ...
                  <div key={c.id} style={{
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "10px", flexWrap: "wrap" }}>
                      <span style={{
                        ...
                        color: c.status === "rejected" ? "white" : c.status === "pending" ? "black" : "white",
                      }}>
                        {statusLabel}
                      </span>
                    ...
                    <div style={{ display: "flex", gap: "10px", alignItems: "center", flexWrap: "wrap" }}>
                      ...
                      {!p.promotion_validated ? (
                        <button
                          onClick={() => {
                            if (!p.federation_id) {
                              alert("Choisis d'abord une fédération avant de valider !");
                              return;
                            }
                        ...
                        <button
                          onClick={() => unvalidatePromoteur(p.id)}
                          style={{
                            display: "inline-flex",
                            alignItems: "center",
                            gap: "6px",
          ...
          <div>
            <div style={{ marginBottom: "16px", display: "flex", justifyContent: "flex-end" }}>
              <button
                onClick={() => { setEditingFed(null); setFedForm(true); }}
                style={btnAdd}
              >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
              {displayedShows.map((show) => {
                ...
                return (
                  <div
                    key={show.id}
                    style={{ ...rowStyle, opacity: tab === "past" ? 0.6 : 1 }}
                  >
              ...
              {displayedShows.length === 0 && (
                <div style={{
                  ...
                  {tab === "past" ? "AUCUN SHOW PASSE" : "AUCUN SHOW A VENIR"}
                </div>
              )}
            </div>
          </div>
